    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFlash = '<object class="kv-preview-data file-object" type="application/x-shockwave-flash" ' +
                ...
                '\n</object>\n';
            tObject = '<object class="kv-preview-data file-object {typeCss}" data="" type="{type}" ' +
            ...
            vDefaultDim = {width: "100%", height: "100%", 'min-height': "80px"};
            self.defaults = {
                layoutTemplates: {
                    main1: tMain1,
                    main2: tMain2,
                ...
                previewZoomSettings: {
                    ...
                    object: { width: "auto", height: "100%", 'max-width': "100%", 'min-height': "100%" },
                    pdf: vDefaultDim,
                    other: vDefaultDim
                },
                fileTypeSettings: {
